...
social:
  ...
  Weibo: https://weibo.com/3655576503/
  Zhihu: https://www.zhihu.com/people/flowsnow/activities
...
links:
  mjqin: https://mjqin.github.io/
  jcf94: https://jcf94.com/
  bigballon: https://bigballon.github.io/
...
# Gentie productKey
gentie_productKey: 15512e5e9af7414788f31bdc0b5734a9
...
add_this_id: ra-5842dab3d40f9239
...
subtitle: 关注自动化运维平台的那点事儿
description: 专注于Linux自动化运维，python开发，Oracle数据库等领域。
author: Flowsnow
language: en
timezone:
...
avatar: https://flowsnow.oss-cn-shanghai.aliyuncs.com/history/avatar.png

# Duoshuo ShortName
# duoshuo_shortname: FlowsnowGithubIo

# Disqus
# disqus_shortname: flowsnow
...
菜单添加language，避免出现menu.links这种形式的菜单
http://theme-next.iissnan.com/faqs.html#setting-menu
