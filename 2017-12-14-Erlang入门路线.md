...
推荐阅读Erlang之父Joe Armstrong编写的**Erlang程序设计**这本书，网上有pdf版本。也可参见[Erlang学习笔记1](http://flowsnow.net/2017/08/11/Erlang%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0(1)/)。 
...
1. **Erlang程序设计**书后练习题
2. [Erlang 官方练习题](http://erlang.org/course/exercises.html)
...
OTP的application构建时需要遵循一定的约定来组织项目，具体的约定参考：[OTP应用设计原则](http://erlang.org/doc/design_principles/applications.html)。rebar遵循OTP设计原则，因此rebar构建的项目目录需要下列子文件夹：
...
rebar具体的构建方法参见：[**Rebar：Erlang构建工具**](http://www.cnblogs.com/panfeng412/archive/2011/08/14/compile-erlang-with-rebar.html)
...
- [Erlang 中的并发 -- Actor 模型](http://blog.csdn.net/wwh578867817/article/details/49774169)
