...
微博热搜榜地址：`http://s.weibo.com/top/summary?cate=realtimehot`，具体爬取代码如下，其中最终的部分在于对热搜标题中的反扒处理，具体可参见[简书中的爬取新浪微博热搜](https://www.jianshu.com/p/e6c24feeb806)。具体代码如下：
